...
const NewsCard: FC<INewsCard> = ({date, img, sub_title, title, author}) => {
    return (
        <div className={"news-card"} >
            <div className="news-card-content">
                ...
                <div className="news-card-information">
                    <div className="news-information-author">
                    ...
                    <BigButton button_color={"#EFD372"} text_color={"#274C5B"} text={"Read more"}/>
                </div>
            </div>
        </div>
    );
