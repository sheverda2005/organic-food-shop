                    ...
                    <div className={"single-product-content"}>
                        <div className="product-general-info">
                            <div className="product-image">
                                ...
                                <img src={`https://organic-food-shop-server.vercel.app/api/getImage/${product[0].img}`}
                            ...
                            <div className="product-general-text">
                                ...
                                <div className="add-to-card">
                                    ...
                                    <div onClick={() => {
                                        ...
                                        <button disabled={addedToCard}
                                                style={{backgroundColor: addedToCard ? "#EFF6F1" : "#274C5B"}}
