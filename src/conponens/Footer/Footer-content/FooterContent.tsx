                ...
                <div className="footer-content-blocks">
                    ...
                    <div className="footer-content-bloc logo-media">
                        ...
                        <div className="media-items">
                            <MediaSVGItem svg={<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <MediaSVGItem svg={<svg width="21" height="18" viewBox="0 0 21 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <MediaSVGItem svg={<svg width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
