            ...
            <div className="container">
                <div className="about-choose-us-content">
                    ...
                    <div className="choose-us-cards">
                        <AboutChooseUsCard svg={'/image/Choose-us-1.svg'} title={"Return Policy"} text={"Simply dummy text of the printintypesetting industry."}/>
                        <AboutChooseUsCard svg={'/image/Choose-us-2.svg'} title={"100% Fresh"} text={"Simply dummy text of the printintypesetting industry."}/>
                        <AboutChooseUsCard svg={'/image/Choose-us-3.svg'} title={"Secured Payment"} text={"Simply dummy text of the printintypesetting industry."}/>
                        <AboutChooseUsCard svg={'/image/Choose-us-4.svg'} title={"Secured Payment"} text={"Simply dummy text of the printintypesetting industry."}/>
                    </div>
                </div>
            </div>
        </div>
